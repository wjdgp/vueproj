  ...
  <div>
    <b-modal id="modal-department-inform" :title="getTitle" @ok="onSubmit">
      <div>
        ...
        <b-form-group label-cols="4" label="부서명" label-for="name">
          <b-form-input id="name" v-model="department.name"></b-form-input>
        </b-form-group>
        <b-form-group label-cols="4" label="부서코드" label-for="code" description="중복코드는 허용되지 않습니다">
          <b-form-input id="code" v-model="department.code"></b-form-input>
        </b-form-group>
        <b-form-group label-cols="4" label="상세설명" label-for="description">
          <b-form-textarea id="description" v-model="department.description" placeholder="상세설명"></b-form-textarea>
        </b-form-group>
